  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (isExist) {
        ...
        userData.errCode = 1;
        userData.errMessage =
          "Your's email isn't exist in our system. Please try other email";
      }
      resolve(userData);
    } catch (e) {
      reject(e);
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (check === true) {
        resolve({
          errCode: 1,
          errMessage: "Your email is already in used, Please try orther",
        });
      } else {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (user) {
        ...
        resolve({
          errCode: 0,
          errMessage: "Update the user successfly",
        });
      } else {
        resolve({
          errCode: 1,
