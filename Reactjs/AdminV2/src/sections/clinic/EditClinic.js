...
//     let isValid = true;
//     let arrCheck = [email, firstName, lastName, phoneNumber, address, gender, role, avatar];
...
//             value={role}
//           >
//             <option value="">{language === LANGUAGES.VI ? 'Chọn vai trò' : 'Choose role'}</option>
//             {roleArr &&
//               roleArr.length > 0 &&
...
//                             : "Choose status"}
//                         </option> */}
//             <option value="0">{language === LANGUAGES.VI ? 'Hoạt động' : 'Active'}</option>
//             <option value="1">{language === LANGUAGES.VI ? 'Cấm' : 'Banned'}</option>
//           </select>
//         </div>
//         <div class="col-3">
//           <label>
...
//       {isOpen === true && (
//         <Lightbox mainSrc={previewImgURL} onCloseRequest={() => setIsOpen(false)} />
//       )}
//     </div>
//   );
// }
