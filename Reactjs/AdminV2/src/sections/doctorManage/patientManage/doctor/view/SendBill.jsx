...
// import { getDetailInforDoctor, saveDetailDoctorService } from 'src/Services/userService';

// const EditDoctor = ({ open, handleClose, doctorId }) => {
...
//       if (res.errCode === 0) {
//         console.log('Doctor info saved successfully:', res.data);
//         handleClose();
//       } else {
//         console.error('Error saving doctor info:', res.errMessage);
...
//       <DialogTitle>
//         Gửi hóa đơn khám bệnh {doctorInfo?.lastName} {doctorInfo?.firstName}
//       </DialogTitle>
//       <DialogContent>
//         {isLoading ? (
//           <div>Loading...</div>
...
//                 fullWidth
//                 margin="normal"
//                 defaultValue={formData.selectedPrice}
//                 onChange={handleInputChange}
//               >
...
//               <MdEditor
//                 defaultValue={formData.contentMarkdown}
