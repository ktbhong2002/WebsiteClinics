...
function ThemeProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime3.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime3.jsx)(RtlProvider_default, {
        value: rtlValue,
        children
      })
    })
...
var ThemeProvider_default2 = ThemeProvider;
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React6.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => {
    const value = React6.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider(props) {
    ...
    const hasMounted = React6.useRef(false);
    const upperTheme = useTheme();
    const ctx = React6.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime6.jsxs)(React6.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime6.jsxs)(React6.Fragment, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React7.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React8.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React8.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React8.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime8.jsx)(GridRoot, _extends({
      ...
      children: React8.Children.map(children, (child) => {
        if (React8.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime8.jsx)(GridOverflowContext.Provider, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4JFA2DAG.js.map
