...
.cm-search .cm-textfield:hover {
  ...
  background-image: none;
  border-color: var(--md-border-color);
}.cm-search .cm-button:first-of-type {
  margin-left: 0;
  ...
  vertical-align: sub;
}.cm-search input[type='checkbox']::after {
  display: block;
  content: '';
  font-weight: bold;
  cursor: pointer;
