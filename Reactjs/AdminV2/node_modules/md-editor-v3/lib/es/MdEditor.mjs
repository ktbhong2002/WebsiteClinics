...
import { defineComponent, createVNode, inject, ref, onMounted, reactive, computed, watch, nextTick, Fragment, cloneVNode, toRef, shallowRef, onBeforeUnmount } from "vue";
import { p as prefix, e as configOption, l as screenfullUrl, b as allToolbar, M as MinInputBoxWidth, d as allFooter } from "./chunks/config.mjs";
import { draggingScroll, linkTo, debounce, createSmoothScroll, throttle } from "@vavt/util";
import { a as Dropdown, D as DropdownToolbar } from "./chunks/index2.mjs";
import { b as bus, j as CHANGE_FULL_SCREEN, E as ERROR_CATCHER, U as UPLOAD_IMAGE, m as base642File, n as OPEN_MODALS, i as REPLACE, c as CHANGE_CATALOG_VISIBLE, O as ON_SAVE, o as CTRL_SHIFT_Z, p as CTRL_Z, k as EVENT_LISTENER } from "./chunks/index4.mjs";
import { a as appendHandler } from "./chunks/dom.mjs";
import { M as MdModal, I as Icon } from "./chunks/index3.mjs";
...
import MdCatalog from "./MdCatalog.mjs";
...
const ClipModal = /* @__PURE__ */ defineComponent({
  ...
  setup(props2) {
    ...
    const ult = inject("usedLanguageText");
    const editorId = inject("editorId");
    let Cropper = (_c = (_b = (_a = configOption) == null ? void 0 : _a.editorExtensions) == null ? void 0 : _b.cropper) == null ? void 0 : _c.instance;
    const uploadRef = ref();
...
const useResize = (props2, contentRef, resizeRef) => {
  ...
  watch(
    [toRef(props2.setting, "htmlPreview"), toRef(props2.setting, "preview")],
    () => {
...
const Content = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, ctx) {
    ...
    return () => {
      return createVNode("div", {
        "class": `${prefix}-content${props2.setting.htmlPreview || props2.setting.preview ? " has-preview" : ""}`,
        "ref": contentRef
      }, [createVNode("div", {
...
const Editor = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, ctx) {
    ...
    return () => {
      ...
      }, null), ((_a = props2.footers) == null ? void 0 : _a.length) > 0 && createVNode(Footer, {
        "modelValue": props2.modelValue,
