...
const index = require("./chunks/index4.cjs");
const dom = require("./chunks/dom.cjs");
const MdModal = require("./chunks/index3.cjs");
...
const MdCatalog = require("./MdCatalog.cjs");
...
const useSreenfull = (props2) => {
  ...
  let screenfull = (_b = (_a = config.configOption.editorExtensions) == null ? void 0 : _a.screenfull) == null ? void 0 : _b.instance;
  const screenfullJs = (_d = (_c = config.configOption.editorExtensions) == null ? void 0 : _c.screenfull) == null ? void 0 : _d.js;
  const screenfullMe = vue.ref(false);
  const fullscreenHandler = (status) => {
    if (!screenfull) {
      index.bus.emit(editorId, index.ERROR_CATCHER, {
        name: "fullscreen",
  ...
  vue.onMounted(() => {
    ...
    if (!screenfull) {
      ...
      screenScript.src = screenfullJs || config.screenfullUrl;
      screenScript.onload = screenfullLoad;
      screenScript.id = `${config.prefix}-screenfull`;
      dom.appendHandler(screenScript, "screenfull");
    }
  });
  vue.onMounted(() => {
    index.bus.on(editorId, {
      name: index.CHANGE_FULL_SCREEN,
...
const TableShape = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2) {
    ...
    }, [new Array(props2.tableShape[1]).fill("").map((_, rowIndex) => vue.createVNode("div", {
      "class": `${config.prefix}-table-shape-row`,
      "key": `table-shape-row-${rowIndex}`
    }, [new Array(props2.tableShape[0]).fill("").map((_2, colIndex) => vue.createVNode("div", {
...
const ClipModal = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2) {
    ...
    const ult = vue.inject("usedLanguageText");
    const editorId = vue.inject("editorId");
    let Cropper = (_c = (_b = (_a = config.configOption) == null ? void 0 : _a.editorExtensions) == null ? void 0 : _b.cropper) == null ? void 0 : _c.instance;
            ...
            fileReader.onload = (e) => {
              ...
              vue.nextTick(() => {
                cropper = new Cropper(uploadImgRef.value, {
                  viewMode: 2,
                  preview: `.${config.prefix}-clip-preview-target`
                  // aspectRatio: 16 / 9,
                });
              });
            };
          ...
          return [vue.createVNode("div", {
            ...
            "onClick": () => {
              if (cropper) {
                ...
                index.bus.emit(editorId, index.UPLOAD_IMAGE, [index.base642File(cvs.toDataURL("image/png"))], props2.onOk);
                reset();
              }
            }
          }, [((_a3 = ult.value.clipModalTips) == null ? void 0 : _a3.buttonUpload) || ((_b2 = ult.value.linkModalTips) == null ? void 0 : _b2.buttonOK)])]), vue.createVNode("input", {
            "ref": uploadRef,
            "accept": "image/*",
            "type": "file",
            "multiple": false,
...
const ToolBar = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2) {
    ...
    const emitHandler = (direct, params) => {
      index.bus.emit(editorId, index.REPLACE, direct, params);
    };
    ...
    const uploadRef = vue.ref();
    const uploadHandler = () => {
      index.bus.emit(editorId, index.UPLOAD_IMAGE, Array.from(uploadRef.value.files || []));
      uploadRef.value.value = "";
    };
    vue.onMounted(() => {
      ...
      if (config.allToolbar.includes(barItem)) {
        switch (barItem) {
          ...
          case "table": {
            return vue.createVNode(DropdownToolbar.Dropdown, {
              ...
              "key": "bar-table",
              "overlay": vue.createVNode(TableShape$1, {
          ...
          case "revoke": {
            return vue.createVNode("div", {
              ...
              "onClick": () => {
                index.bus.emit(editorId, index.CTRL_Z);
              }
            }, [vue.createVNode(MdModal.Icon, {
              "name": "revoke"
            }, null), props2.showToolbarName && vue.createVNode("div", {
          ...
          case "next": {
            return vue.createVNode("div", {
              ...
              "onClick": () => {
                index.bus.emit(editorId, index.CTRL_SHIFT_Z);
              }
            }, [vue.createVNode(MdModal.Icon, {
              "name": "next"
            }, null), props2.showToolbarName && vue.createVNode("div", {
          ...
          case "catalog": {
            return vue.createVNode("div", {
              ...
              "onClick": () => {
                index.bus.emit(editorId, index.CHANGE_CATALOG_VISIBLE);
              },
              "key": "bar-catalog"
            }, [vue.createVNode(MdModal.Icon, {
              "name": "catalog"
        ...
        if (defItem) {
          const defItemCloned = vue.cloneVNode(defItem, {
            ...
            insert(generate) {
              index.bus.emit(editorId, index.REPLACE, "universal", {
                generate
              });
            }
          });
    ...
    return () => {
      ...
      }, [RightBar])])]), vue.createVNode("input", {
        "ref": uploadRef,
        "accept": "image/*",
        "type": "file",
        "multiple": true,
...
const DATA_LINE_SELECTOR = `.${config.prefix}-preview > [data-line]`;
const scrollAutoWithScale = (pEle, cEle) => {
  const addEvent = util.debounce(() => {
...
const scrollAuto = (pEle, cEle, codeMirrorUt) => {
  const { view: view2 } = codeMirrorUt;
  const smoothScroll = util.createSmoothScroll();
  const getTopByLine = (line) => {
    return view2.lineBlockAt(view2.state.doc.line(line).from).top;
  };
  const getHeightByLine = (line) => {
    return view2.lineBlockAt(view2.state.doc.line(line).from).height;
  };
  let blockMap = [];
  ...
  const pEleHandler = () => {
    ...
    pLock++;
    const { scrollDOM, contentHeight } = view2;
    let cElePaddingTop = +getComputedStyle(cEle).paddingTop.replace("px", "");
    const blockInfo = view2.lineBlockAtHeight(scrollDOM.scrollTop);
    const { number: currLine } = view2.state.doc.lineAt(blockInfo.from);
    ...
    const startEle = cEle.querySelector(`[data-line="${blockData.start - 1}"]`) || ((_a = cEle.firstElementChild) == null ? void 0 : _a.firstElementChild);
  ...
  const cEleHandler = () => {
    ...
    let endLineScrollTop = getTopByLine(end === view2.state.doc.lines ? end : end + 1);
    let blockHeight = 0;
    if (endLineScrollTop > scrollDOM.scrollHeight - scrollDOM.clientHeight || realEleEnd.scrollTop > cEle.scrollHeight - cEle.clientHeight) {
      ...
      endLineScrollTop = getTopByLine(view2.state.doc.lines) + getHeightByLine(view2.state.doc.lines);
  ...
  const scrollHandler = util.throttle((e) => {
    var _a;
    const { scrollDOM, contentHeight } = view2;
    ...
    if (view2.state.doc.lines < ((_a = blockMap[blockMap.length - 1]) == null ? void 0 : _a.end)) {
      return false;
    }
    if (e.target === pEle) {
      pEleHandler();
...
const directive2flag = (direct, codeMirrorUt, params) => {
  var _a, _b, _c, _d, _e, _f;
  let targetValue = "";
  ...
  const mermaidTemplate = (_a = config.configOption.editorConfig) == null ? void 0 : _a.mermaidTemplate;
  if (/^h[1-6]{1}$/.test(direct)) {
    ...
    const prettier = window.prettier || ((_c = (_b = config.configOption.editorExtensions) == null ? void 0 : _b.prettier) == null ? void 0 : _c.prettierInstance);
    const prettierPlugins = [
      ((_d = window.prettierPlugins) == null ? void 0 : _d.markdown) || ((_f = (_e = config.configOption.editorExtensions) == null ? void 0 : _e.prettier) == null ? void 0 : _f.parserMarkdownInstance)
    ];
    if (!prettier || prettierPlugins[0] === void 0) {
      index.bus.emit(params.editorId, index.ERROR_CATCHER, {
        name: "prettier",
    ...
    try {
      ...
      if (options.select) {
        ...
        this.view.dispatch({
          selection: state.EditorSelection.create(
            [
              state.EditorSelection.range(from + options.deviationStart, to),
              state.EditorSelection.cursor(to)
            ],
            1
          )
        });
  ...
  const pasteHandler = (e) => {
    ...
    if (templateStart) {
      index.bus.emit(editorId, index.REPLACE, "universal", {
        generate() {
          return {
            targetValue: props2.transformImgUrl(targetValue)
          };
        }
      });
      e.preventDefault();
      ...
      const matchArr = targetValue.match(new RegExp(`(?<=!\\[.*\\]\\()\\S+(?=\\s?["']?.*["']?\\))`));
      index.bus.emit(editorId, index.REPLACE, "universal", {
        generate() {
          return {
            targetValue: matchArr ? targetValue.replace(matchArr[0], props2.transformImgUrl(matchArr[0])) : targetValue
          };
        }
      });
      e.preventDefault();
    ...
    if (props2.autoDetectCode && e.clipboardData.types.includes("vscode-editor-data")) {
      ...
      index.bus.emit(editorId, index.REPLACE, "code", {
...
const createCommands = (id, contentProps) => {
  const CtrlB = {
    ...
    mac: "Cmd-b",
    run: () => {
      index.bus.emit(id, index.REPLACE, "bold");
      return true;
    }
  };
  const CtrlS = {
    ...
    mac: "Cmd-s",
    run: (view2) => {
      index.bus.emit(id, index.ON_SAVE, view2.state.doc.toString());
      return true;
    },
    shift: () => {
      index.bus.emit(id, index.REPLACE, "strikeThrough");
      return true;
    }
  };
  const CtrlU = {
    ...
    mac: "Cmd-u",
    run: () => {
      index.bus.emit(id, index.REPLACE, "underline");
      return true;
    },
    shift: () => {
      index.bus.emit(id, index.REPLACE, "unorderedList");
      return true;
    }
  };
  const CtrlI = {
    ...
    mac: "Cmd-i",
    run: () => {
      index.bus.emit(id, index.REPLACE, "italic");
      return true;
    },
    shift: () => {
      index.bus.emit(id, index.OPEN_MODALS, "image");
      return true;
    }
  };
  const Ctrl1 = {
    ...
    mac: "Cmd-1",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h1");
      return true;
    }
  };
  const Ctrl2 = {
    ...
    mac: "Cmd-2",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h2");
      return true;
    }
  };
  const Ctrl3 = {
    ...
    mac: "Cmd-3",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h3");
      return true;
    }
  };
  const Ctrl4 = {
    ...
    mac: "Cmd-4",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h4");
      return true;
    }
  };
  const Ctrl5 = {
    ...
    mac: "Cmd-5",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h5");
      return true;
    }
  };
  const Ctrl6 = {
    ...
    mac: "Cmd-6",
    run: () => {
      index.bus.emit(id, index.REPLACE, "h6");
      return true;
    }
  };
  const CtrlArrowUp = {
    ...
    mac: "Cmd-ArrowUp",
    run: () => {
      index.bus.emit(id, index.REPLACE, "sup");
      return true;
    }
  };
  const CtrlArrowDown = {
    ...
    mac: "Cmd-ArrowDown",
    run: () => {
      index.bus.emit(id, index.REPLACE, "sub");
      return true;
    }
  };
  const CtrlO = {
    ...
    mac: "Cmd-o",
    run: () => {
      index.bus.emit(id, index.REPLACE, "orderedList");
      return true;
    }
  };
  const CtrlC = {
    ...
    mac: "Cmd-c",
    shift: () => {
      index.bus.emit(id, index.REPLACE, "code");
      return true;
    },
    any(_view, e) {
      if ((e.ctrlKey || e.metaKey) && e.altKey && e.code === "KeyC") {
        index.bus.emit(id, index.REPLACE, "codeRow");
        return true;
      }
      return false;
    }
  ...
  const CtrlL = {
    ...
    mac: "Cmd-l",
    run: () => {
      index.bus.emit(id, index.OPEN_MODALS, "link");
      return true;
    }
  };
  const CtrlF = {
    ...
    shift: () => {
      if (!contentProps.noPrettier) {
        index.bus.emit(id, index.REPLACE, "prettier");
        return true;
      }
      return false;
    }
  ...
  const CtrlT = {
    any: (_view, e) => {
      if ((e.ctrlKey || e.metaKey) && e.altKey && e.shiftKey && e.code === "KeyT") {
        index.bus.emit(id, index.REPLACE, "table");
        return true;
      }
      return false;
    }
...
const useCodeMirror = (props2) => {
  ...
  const defaultExtensions = [
    view.keymap.of([...commands.defaultKeymap, ...commands.historyKeymap, ...mdEditorCommands, commands.indentWithTab]),
  ...
  const getExtensions = () => {
    ...
    return config.configOption.codeMirrorExtensions(theme.value, extensions, [
      ...mdEditorCommands
    ]);
  };
  vue.onMounted(() => {
...
const useResize = (props2, contentRef, resizeRef) => {
  ...
  vue.watch(
    [vue.toRef(props2.setting, "htmlPreview"), vue.toRef(props2.setting, "preview")],
    () => {
      if (!props2.setting.htmlPreview && !props2.setting.preview) {
...
const Content = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2, ctx) {
    ...
    return () => {
      return vue.createVNode("div", {
        "class": `${config.prefix}-content${props2.setting.htmlPreview || props2.setting.preview ? " has-preview" : ""}`,
        "ref": contentRef
      }, [vue.createVNode("div", {
      ...
      }, null), props2.catalogVisible && vue.createVNode(MdCatalog, {
        "theme": props2.theme,
    ...
    const footerRender = (name) => {
      if (config.allFooter.includes(name)) {
        switch (name) {
          ...
          case "scrollSwitch": {
            return vue.createVNode(ScrollAuto, {
...
const Editor = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2, ctx) {
    ...
    return () => {
      ...
      }, null), ((_a = props2.footers) == null ? void 0 : _a.length) > 0 && vue.createVNode(Footer, {
        "modelValue": props2.modelValue,
...
Editor.install = (app) => {
  ...
  app.use(NormalToolbar).use(DropdownToolbar.DropdownToolbar).use(ModalToolbar).use(MdCatalog).use(MdPreview.MdPreview);
  return app;
};
