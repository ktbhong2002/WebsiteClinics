...
class RestoreUser extends Component {
  ...
  handleRestoreUserByEmail = async (email) => {
    ...
    if (res && res.errCode == 0) {
      ...
      if (language == "en") {
        toast.success("Restore user Unsuccessfully!");
      } else {
        toast.success("Khôi phục người dùng không thành công!");
      }
    }
  ...
  handleDeleteRestoreUser = async (email) => {
    ...
    if (res && res.errCode == 0) {
      if (language == "en") {
        toast.success("Delete user permanent successfully!");
      } else {
        toast.success("Xóa người dùng vĩnh viễn thành công!");
      }
    } else {
      if (language == "en") {
        toast.success("Delete user permanent Unsuccessfully!");
      } else {
        toast.success("Xóa người dùng vĩnh viễn không thành công!");
      }
    }
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(RestoreUser)
);
